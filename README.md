...
The authenticated Host lifecycle contract reports exact queued/running jobs and non-interruptible apply stages. Graceful shutdown drains new work, waits or refuses according to the caller's policy, and always preserves an attached Player.
